package com.smg.variety.view.widgets.tablayout;
...
import com.smg.variety.view.widgets.tablayout.listener.OnTabSelectListener;
import com.smg.variety.view.widgets.tablayout.transformer.IViewPagerTransformer;
import com.smg.variety.view.widgets.tablayout.transformer.TabScaleTransformer;
import com.smg.variety.view.widgets.tablayout.utils.UnreadMsgUtils;
import com.smg.variety.view.widgets.tablayout.widget.MsgView;
...
//            v.setPadding((int) mTabPadding, v.getPaddingTop(), (int) mTabPadding, v.getPaddingBottom());
   ...
   public interface  TabSelectionListener{
        void selection(int poition);
   }
   private TabSelectionListener listener;
    public void setmTabsContainer(TabSelectionListener listener){
