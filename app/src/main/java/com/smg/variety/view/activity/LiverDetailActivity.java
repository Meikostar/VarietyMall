            ...
            public void onSuccess(HttpResult<VideoLiveBean> result) {
                ...
                if (result != null && result.getData() != null) {
                    ...
                    if (result.getData().getUser() != null && result.getData().getUser().getData() != null) {
                        GlideUtils.getInstances().loadRoundImg(LiverDetailActivity.this, ivImg, Constants.WEB_IMG_URL_UPLOADS + result.getData().getUser().getData().getAvatar(), R.drawable.moren_ren);
