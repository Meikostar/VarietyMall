...
import com.smg.variety.view.fragments.HotFragment;
...
public class HotActivity extends BaseActivity {
    ...
    public void initView() {
        ...
        autoScroll.setBackgroundColor(getResources().getColor(R.color.my_color_qls));
        viewpagerMain.setBackgroundColor(getResources().getColor(R.color.my_color_qls));
