 ...
 */
public class LiveItemAdapter extends BaseQuickAdapter<VideoLiveBean, BaseViewHolder> {
    private Context mContext;

    public LiveItemAdapter(List<VideoLiveBean> data, Context mContext) {
        super(R.layout.item_live_view, data);
    ...
    protected void convert(BaseViewHolder helper, VideoLiveBean item) {
        ...
        GlideUtils.getInstances().loadRoundImg(mContext,iv_img,item.getUser().getData().getAvatar(),R.drawable.moren_ren);
