...
public class WebViewsActivity extends BaseActivity {
    ...
    android.webkit.WebView webviewWebView;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        webviewWebView.getSettings().setDefaultTextEncodingName("utf-8");
        ...
        webviewWebView.setWebChromeClient(new WebChromeClient() {
            ...
            public void onGeolocationPermissionsShowPrompt(String origin,GeolocationPermissions.Callback callback) {
                ...
                if (Build.VERSION.SDK_INT >= 23) {
                    int checkPermission = ContextCompat.checkSelfPermission(WebViewsActivity.this, Manifest.permission.ACCESS_COARSE_LOCATION);
                    if (checkPermission != PackageManager.PERMISSION_GRANTED) {
                        ActivityCompat.requestPermissions(WebViewsActivity.this, new String[]{Manifest.permission.ACCESS_COARSE_LOCATION}, 1);
                        ActivityCompat.requestPermissions(WebViewsActivity.this, new String[]{Manifest.permission.ACCESS_FINE_LOCATION}, 1);
