...
import com.smg.variety.view.adapter.MembersAdapter;
...
public class MembersFragment extends BaseFragment {
    ...
    private MembersAdapter mOrderListAdapter;

    private String id;
    private int mPage = 1;


    public static MembersFragment newInstance(String type) {
    ...
    protected void initView() {
        ...
        mOrderListAdapter = new MembersAdapter(getActivity());
    ...
    private void loadData() {
        ...
        map.put("filter[level]", id);
        DataManager.getInstance().getChildren(new DefaultSingleObserver<HttpResult<List<ScoreIncomeBean>>>() {
            @Override
