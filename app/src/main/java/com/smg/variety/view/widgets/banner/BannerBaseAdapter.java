package com.smg.variety.view.widgets.banner;
...
public abstract class BannerBaseAdapter<T> extends PagerAdapter {
    ...
    public ScrollPostionListener mScrollPostionListener;

    public void setScrollPostionListener(ScrollPostionListener listener){
        mScrollPostionListener=listener;
    }
    @Override
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        if (mDatas != null) {
            // 处理视图和数据
            if(mScrollPostionListener!=null){
                mScrollPostionListener.selectPosition(position);
            }
